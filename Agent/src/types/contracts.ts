...
export const HOME_CONTRACT_ABI = [
  ...
  "function getaipProgress(address user) view returns (uint256 monthlyAmount, uint256 totalTarget, uint256 totalDeposited, uint256 percentComplete, uint256 nextDepositTime, bool isActive, bool automationEnabled, string memory goal)",
  ...
  "function getActiveaipCount() view returns (uint256)",
...
// aipToken.sol ABI (ERC20 Token)
export const aip_TOKEN_ABI = [
  "function balanceOf(address account) view returns (uint256)",
  "function transfer(address to, uint256 value) returns (bool)",
  "function approve(address spender, uint256 value) returns (bool)",
  "function allowance(address owner, address spender) view returns (uint256)",
